...
select*from salese right join sales_second_data on salese.Prdct_Name=sales_second_data.Item_Name;

create table right_join_table as select*from salese right join sales_second_data on salese.Prdct_Name=sales_second_data.Item_Name;

select*from salese inner join sales_second_data on salese.Prdct_Name=sales_second_data.Item_Name inner join sales_thrd_data on 
sales_thrd_data.PVT_Limited_companies=salese.Cmpnies;

create table merged_table as select*from salese inner join sales_second_data on salese.Prdct_Name=sales_second_data.Item_Name inner join sales_thrd_data on 
sales_thrd_data.PVT_Limited_companies=salese.Cmpnies;
...
select merged_table.Order_Num,merged_table.cmpnies,merged_table.City_State,merged_table.Prdct_Name,merged_table.Income,merged_table.Expenses,
merged_table.Tot_profit,merged_table.Product_ID,merged_table.Mobile_No,merged_table.Mail_ID from merged_table;

create table merged_table_two as select merged_table.Order_Num,merged_table.cmpnies,merged_table.City_State,merged_table.Prdct_Name,merged_table.Income,merged_table.Expenses,
merged_table.Tot_profit,merged_table.Product_ID,merged_table.Mobile_No,merged_table.Mail_ID from merged_table;
